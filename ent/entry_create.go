...
func (ec *EntryCreate) SetAccountID(i int) *EntryCreate {
	ec.mutation.SetAccountID(i)
	return ec
}

// SetAmount sets the "amount" field.
func (ec *EntryCreate) SetAmount(i int) *EntryCreate {
...
func (ec *EntryCreate) SetAccountsID(id int) *EntryCreate {
	ec.mutation.SetAccountsID(id)
	return ec
}

// SetAccounts sets the "accounts" edge to the Account entity.
func (ec *EntryCreate) SetAccounts(a *Account) *EntryCreate {
...
func (ec *EntryCreate) check() error {
	...
	if _, ok := ec.mutation.AccountsID(); !ok {
		return &ValidationError{Name: "accounts", err: errors.New(`ent: missing required edge "Entry.accounts"`)}
	}
	return nil
}
