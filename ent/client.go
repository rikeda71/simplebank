...
// QueryFromTransfers queries the from_transfers edge of a Account.
func (c *AccountClient) QueryFromTransfers(a *Account) *TransferQuery {
...
// QueryToTransfers queries the to_transfers edge of a Account.
func (c *AccountClient) QueryToTransfers(a *Account) *TransferQuery {
	query := &TransferQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := a.ID
		step := sqlgraph.NewStep(
...
// QueryAccounts queries the accounts edge of a Entry.
func (c *EntryClient) QueryAccounts(e *Entry) *AccountQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, entry.AccountsTable, entry.AccountsColumn),
		)
...
// QueryFromAccounts queries the from_accounts edge of a Transfer.
func (c *TransferClient) QueryFromAccounts(t *Transfer) *AccountQuery {
	query := &AccountQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := t.ID
		step := sqlgraph.NewStep(
...
// QueryToAccounts queries the to_accounts edge of a Transfer.
func (c *TransferClient) QueryToAccounts(t *Transfer) *AccountQuery {
	query := &AccountQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := t.ID
		step := sqlgraph.NewStep(
